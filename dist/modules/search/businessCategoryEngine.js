...
exports.businessCategoryEngine = void 0;
exports.expandKeyword = expandKeyword;
exports.getCategoryGroup = getCategoryGroup;
exports.getAllCategoryGroups = getAllCategoryGroups;
exports.getCategoryGroupsByPriority = getCategoryGroupsByPriority;
exports.findAISemanticMatch = findAISemanticMatch;
...
const KEYWORD_TO_GROUP_MAP = new Map();
const PRIORITY_ORDER = [...CATEGORY_GROUPS].sort((a, b) => a.priority - b.priority);
function buildIndex() {
...
function findMatchingGroup(input) {
...
function getCategoryGroup(input) {
    const normalized = normalizeKeyword(input);
...
function getAllCategoryGroups() {
    return CATEGORY_GROUPS;
}
function getCategoryGroupsByPriority(ascending = true) {
    return ascending ? PRIORITY_ORDER : [...PRIORITY_ORDER].reverse();
}
function findAISemanticMatch(input) {
    const normalized = normalizeKeyword(input);
    const travelKeywords = ['travel', 'travels', 'tour', 'tours', 'tourism', 'holiday', 'vacation', 'trip', 'honeymoon', 'pilgrimage'];
    const logisticsKeywords = ['logistics', 'cargo', 'freight', 'courier', 'warehouse', 'transport company'];
    const containsTravelTerm = travelKeywords.some(term => normalized.includes(term));
...
exports.businessCategoryEngine = {
    expandKeyword,
    getCategoryGroup,
...
//# sourceMappingURL=businessCategoryEngine.js.map