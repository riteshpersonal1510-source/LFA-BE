...
exports.buildAuditSummary = buildAuditSummary;
const website_analysis_service_1 = require("../../services/website-analysis.service");
function getSocialProfiles(lead) {
    return lead.socialProfiles || {};
}
function getSocialLinks(lead) {
    return lead.socialLinks || {};
}
function classifyWebsiteType(lead) {
    const platforms = [];
...
function getSocialOnlyPlatforms(lead) {
    const platforms = [];
...
function getOpportunityReasons(lead) {
    const reasons = [];
...
function getConversionLimitations(lead) {
    const limitations = [];
...
function getSeoOpportunity(lead) {
...
function getRedesignPotential(lead) {
...
function getDigitalMarketingOpportunity(lead) {
...
function buildAuditSummary(lead) {
