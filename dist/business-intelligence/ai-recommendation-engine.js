...
exports.aiRecommendationEngine = exports.AIRecommendationEngine = void 0;
const logger_1 = require("../utils/logger");
class AIRecommendationEngine {
    generateRecommendation(opportunity, factors, qualityScore) {
        try {
            const services = [];
            const keyIssues = [];
            if (factors.poorSEO) {
            ...
            logger_1.logger.info(`AI recommendation generated: services=${services.length}, priority=${opportunity.level}`);
            return recommendation;
        }
        catch (error) {
            logger_1.logger.error(error instanceof Error ? error : new Error(String(error)), 'Failed to generate AI recommendation:');
            return this.getDefaultRecommendation();
        }
    }
    generateSummary(opportunity, services, issues) {
    ...
    estimateImpact(level, serviceCount) {
...
exports.aiRecommendationEngine = new AIRecommendationEngine();
//# sourceMappingURL=ai-recommendation-engine.js.map