...
exports.validateAddressConsistency = validateAddressConsistency;
exports.normalizeCategory = normalizeCategory;
exports.getVerificationScore = getVerificationScore;
...
function validateAddressConsistency(address, state, city) {
    const issues = [];
...
function getVerificationScore(lead) {
    let score = 0;
    const maxScore = 100;
    if (lead.phone) {
    ...
    if (lead.email) {
        ...
        if (emailInfo.validationResult === 'valid')
            score += 20;
