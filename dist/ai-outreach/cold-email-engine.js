...
exports.coldEmailEngine = exports.ColdEmailEngine = void 0;
class ColdEmailEngine {
    generateWebsiteRedesignEmail(lead) {
    ...
    generateDigitalMarketingEmail(lead) {
    ...
    getStrengths(lead) {
        ...
        if (lead.reviewsCount && lead.reviewsCount > 50)
            strengths.push('active customer engagement');
        if (lead.trustScore !== undefined && lead.trustScore >= 70)
            strengths.push('solid trust signals');
        if (lead.socialPresenceScore !== undefined && lead.socialPresenceScore >= 60)
            strengths.push('decent social media presence');
        return strengths;
    }
}
exports.ColdEmailEngine = ColdEmailEngine;
exports.coldEmailEngine = new ColdEmailEngine();
//# sourceMappingURL=cold-email-engine.js.map