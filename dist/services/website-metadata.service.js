...
exports.websiteMetadataService = exports.WebsiteMetadataService = void 0;
const CMS_PATTERNS = [
...
class WebsiteMetadataService {
    ...
    extractFavicon(html, baseUrl) {
        ...
        if (m2)
            return this.resolveUrl(m2[1], baseUrl);
        return `${baseUrl.replace(/\/+$/, '')}/favicon.ico`;
    }
    extractLogo(html, baseUrl) {
        const patterns = [
            /<img[^>]*id=["']logo["'][^>]*src=["']([^"']+)["']/i,
...
exports.WebsiteMetadataService = WebsiteMetadataService;
exports.websiteMetadataService = new WebsiteMetadataService();
//# sourceMappingURL=website-metadata.service.js.map