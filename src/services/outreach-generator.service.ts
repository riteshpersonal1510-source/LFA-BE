...
export class OutreachGeneratorService {
  ...
  private generateColdEmail(name: string, hasWebsite: boolean, websiteWeak: boolean, city: string, state: string, email?: string, phone?: string): string {
...
Digital Growth Team`;
  ...
  private generateWhatsApp(name: string, hasWebsite: boolean, websiteWeak: boolean): string {
  ...
  private generateCallScript(name: string, hasWebsite: boolean, websiteWeak: boolean, city: string, phone?: string): string {
  ...
  private generateProposal(name: string, hasWebsite: boolean, websiteWeak: boolean, issues?: string[]): string {
    const lines: string[] = [];
